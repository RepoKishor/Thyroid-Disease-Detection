...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = self.columnsPreprocessing(df=base_df)
            base_df.replace({"?":np.NAN},inplace=True)
            logging.info(f"Replace na value in base df: {base_df}")
            ...
            train_df = self.columnsPreprocessing(df=train_df)
            ...
            #logging.info(f"Tumor value in test_df: {test_df['tumor']}--")
